...
function starterweapons:start() 
	-- Corellia
		spawnMobile("corellia", "starter_weapons", 1, -134.5, 28.0, -4766.2, -38, 0 ) -- Coronet
		spawnMobile("corellia", "starter_weapons", 1, -5035.5, 21.0, -2317.7, -9, 0 ) -- Tyrena
		spawnMobile("corellia", "starter_weapons", 1, -3107.5, 31.0, 2795.0, -72, 0 ) -- Kor Vella
	-- Naboo
		spawnMobile("naboo", "starter_weapons", 1, -4848.95, 6.0, 4145.25, 133, 0 ) -- Theed
		spawnMobile("naboo", "starter_weapons", 1, 4831.54, 4.17, -4688.69, -108, 0 ) -- Moenia
		spawnMobile("naboo", "starter_weapons", 1, 5193.96, -192, 6663.05, 76, 0 ) -- Kaadara
	-- Talus
		spawnMobile("talus", "starter_weapons", 1, -2228.2, 20, 2328.3, 117, 0 ) -- Imperial Outpost
	-- Tatooine
