...
function startergear:start() 
	-- Corellia
		spawnMobile("corellia", "starter_gear", 1, -133.5, 28.0, -4765.2, -38, 0 ) -- Coronet
		spawnMobile("corellia", "starter_gear", 1, -5034.5, 21.0, -2316.7, -9, 0 ) -- Tyrena
		spawnMobile("corellia", "starter_gear", 1, -3106.5, 31.0, 2794.0, -72, 0 ) -- Kor Vella
	-- Naboo
		spawnMobile("naboo", "starter_gear", 1, -4847.95, 6.0, 4144.25, -53, 0 ) -- Theed
		spawnMobile("naboo", "starter_gear", 1, 4830.54, 4.17, -4687.69, -109, 0 ) -- Moenia
		spawnMobile("naboo", "starter_gear", 1, 5192.96, -192, 6662.05, 76, 0 ) -- Kaadara
	-- Talus
		spawnMobile("talus", "starter_gear", 1, -2226.9, 20, 2329.11, 117, 0 ) -- Imperial Outpost
	-- Tatooine
